...
public class Perro extends Animales{
    ...
    public Perro(String raza, String tipodeSonido, Color colorPelaje, boolean manchas) {
        this.raza = raza;
    ...
    public Perro(String raza, String tipodeSonido, Color colorPelaje, boolean manchas, int numeroPatas, String sonido, boolean pelaje) {
    ...
    public String toString() {
        return super.toString() + "\nPerro{" + "raza=" + raza + ", tipodeSonido=" + tipodeSonido + ", colorPelaje=" + colorPelaje + ", manchas=" + manchas + '}';
    }
